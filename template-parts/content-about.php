    ...
    <div class="container">
        ...
        <div class="w3_about_grids">
            <div class="col-md-6 w3_about_grid_left">
                <h5>বিশুদ্ধতা হচ্ছে আমাদের ওয়াদা (PURITY IS OUR PRIORITY)</h5>
                <p>আমরা সকলের কথা চিন্তা করে ঈদুল আযহা কে মাথায় রেখে স্বল্প পরিসরে ষাঁড় গরু মোটাতাজা করা শুরু করেছি।
                    ...
                    রোগমুক্ত রাখার উদ্দেশ্যে নিয়মিত ক্রিমির ডোজ এবং ভ্যাক্সিন দিয়ে থাকি। আমাদের কাছ থেকে গরু সংগ্রহ করে
                    যে কোন গ্রাহক বিশুদ্ধতা নিয়ে সম্পূর্ণ নিশ্চিন্ত থাকতে পারবেন। সে নিশ্চয়তা আমারা দিচ্ছি। আমরা সঠিক
                    পদ্ধতিতে পশু পালনের উদাহরণ সৃষ্টির মধ্যে দিয়ে সকল খামারীদের মধ্যে পশুর প্রতি ভালবাসা এবং ভেজালমুক্ত
                ...
                <p>গরু মোটাতাজা করার পাশাপাশি আমরা গাভী পালন শুরু করেছি। বর্তমানে আমরা স্থানীয় বাজারে খাঁটি গরুর দুধ
                    সরবরাহ করছি। খুব শীঘ্রই বিভিন্ন ডেইরী প্রোডাক্ট যেমন ফ্রেশ দুধ, পাস্তরিত দুধ, ঘি, দই, পনির ইত্যাদি
						...
						<?php for ( $i = 4; $i >= 1; $i-- ) { ?>
                            <article style="position: absolute; width: 100%; opacity: 0;">
                                <div class="banner-wrap">
                                    <img src="<?php echo AKONBARIAGRO_ASSETS_URI; ?>/images/farm-<?php echo $i; ?>.jpeg" alt=" "
